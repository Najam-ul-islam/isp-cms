...
// Replicate the calculation logic from services
const calculateUnitProfit = (actualPrice, sellingPrice) => {
  return sellingPrice - actualPrice;
};

const calculateTotalOtherIncome = (actualPrice, sellingPrice, quantity) => {
