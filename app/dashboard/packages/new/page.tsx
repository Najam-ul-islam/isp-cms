...
// Opt out of static generation since this page uses client-side search params
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="p-2 bg-gray-200 dark:bg-gray-700 rounded-lg w-10 h-10 animate-pulse" />
          <div>
        ...
        <div className="px-6 py-5 border-b border-slate-100 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="h-3 w-56 bg-gray-200 dark:bg-gray-700 rounded mt-1 animate-pulse" />
            </div>
          </div>
        </div>
        <div className="p-6">
...
//           </button>
//           <div>
//             {/* Fixed Heading: Using solid colors for better visibility */}
