  ...
  useEffect(() => {
    ...
    const fetchServiceProviderAndPackages = async () => {
      try {
        ...
        // Fetch packages for this service provider
        ...
        // Filter packages by service provider
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-gray-400">
            Manage internet service packages for {serviceProvider?.name}
          </p>
        </div>
        <Link
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-slate-200/60 dark:border-gray-700 overflow-hidden">
        ...
        <div className="px-6 py-5 border-b border-slate-100 dark:border-gray-700 flex items-center justify-between bg-linear-to-r from-purple-50/50 to-transparent dark:from-purple-900/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-semibold text-slate-800 dark:text-white">Packages</h2>
                    ...
                    <div className="flex flex-col items-center gap-4 text-slate-400 dark:text-gray-500">
                      ...
                      <div>
                        ...
                        <p className="text-sm mt-1">
                          {searchTerm ? `No results for "${searchTerm}"` : 'Get started by creating your first package for this service provider'}
                        </p>
                      </div>
                      {!searchTerm && (
                        <Link
